...
First off, thank you for considering contributing to Jester! 🎉

Jester is an open source project, and we love to receive contributions
from our community — **you**!

There are many ways to contribute, from adding a new feature, improving
existing behavior, or also fixing a bug.
...
- Create [issues](https://github.com/Heatblur-Simulations/jester-modding/issues)
  ...
  [discussions](https://github.com/Heatblur-Simulations/jester-modding/discussions).
...
Unsure where to begin contributing to Jester? You can start by looking
through these labels!

- [good first issue](https://github.com/Heatblur-Simulations/jester-modding/issues/?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
...
[search](https://github.com/Heatblur-Simulations/jester-modding/issues?q=is%3Aissue)
...
[pull request](https://github.com/Heatblur-Simulations/jester-modding/pulls) to
...
From there on, it will lead to the changes being incorporated into the official modules and
your changes becoming live for everyone else in the upcoming game patches!
